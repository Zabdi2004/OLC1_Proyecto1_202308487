...
public final class ProgramStore {
    ...
    public void setStrategies(List strategies) { this.strategies = new ArrayList<Strategy>(strategies); }
    public void setMatches(List matches) { this.matches = new ArrayList<Match>(matches); }
    public void setMain(List main) { this.main = new ArrayList<RunInstruction>(main); }
    public List<Strategy> getStrategies() { return Collections.unmodifiableList(strategies); }
    public List<Match> getMatches() { return Collections.unmodifiableList(matches); }
    public List<RunInstruction> getMain() { return Collections.unmodifiableList(main); }
}
